...
router.get('/:key', (0, async_handler_util_1.asyncHandler)(controller.getSetting));
router.put('/:key', (0, validate_middleware_1.validateRequest)(config_validation_1.upsertSettingSchema), (0, async_handler_util_1.asyncHandler)(controller.upsertSetting));
router.delete('/:key', (0, async_handler_util_1.asyncHandler)(controller.deleteSetting));
