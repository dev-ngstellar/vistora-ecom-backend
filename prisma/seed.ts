...
async function main(): Promise<void> {
  ...
  const productDataList = [
    ...
    },
    {
      ...
      description: 'Rich in fiber, vitamins, and minerals compared to polished rice. Naturally wholesome, helps retain natural bran and supports healthy digestion.',
      image: '/products-image all/hand_pounded_lean_rice_front_image.webp',
      color: 'Lean Brown',
      colorHex: '#C4A482',
      stock: 50,
    },
    ...
    // ---------------- Other Grains & Millets (10) ----------------
    {
      ...
      description: 'Rich in calcium, fiber, and plant-based protein. Ideal for porridge, ragi kali, nutritious dosas, and healthy everyday breakfast.',
      image: '/products-image all/ragi_front_image.webp',
    ...
    },
    {
      ...
      description: 'High-fiber, high-protein native grits. Perfect for cooling summer Kambu Koozh, nutritious porridge, upma, and gluten-free adai.',
      image: '/products-image all/kambu_kurunai_front_image.webp',
    ...
    },
    {
      ...
      image: 'https://res.cloudinary.com/ggvs7siw/image/upload/v1789017712/White_cholam_Front.jpg',
      color: 'Pearl Ivory',
      colorHex: '#FFFFF0',
      stock: 55,
    },
    ...
    },
    {
      ...
      image: 'https://res.cloudinary.com/ggvs7siw/image/upload/v1789017709/Thinai_front_image_11zon.jpg.jpg',
      color: 'Golden Yellow',
      colorHex: '#FFD700',
      stock: 65,
    },
    ...
    },
    {
      ...
      image: 'https://res.cloudinary.com/ggvs7siw/image/upload/v1789017711/kollu_frontside.webp',
      color: 'Rust Brown',
      colorHex: '#8B4513',
      stock: 80,
    },
